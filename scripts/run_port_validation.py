"""Port-truth validation harness (backlog A1): export + ingest openEMS |S11| / coupling.

    # Export canonical models (calibration + untuned + TPE best):
    python scripts/run_port_validation.py --out-dir data/port_validation

    # After running openEMS in Octave (see run_openems_all.m in out-dir):
    python scripts/run_port_validation.py --ingest-dir data/port_validation/openems_runs --out data/port_validation_report.json

Requires openEMS + Octave locally for the simulation step; ingest works offline with
``port_metrics.json`` files written by exported ``.m`` scripts.
"""
...
from mw_inv.design_export import cases_from_search_summary, export_all_cases  # noqa: E402
...
from mw_inv.openems_postprocess import ingest_openems_case, load_port_metrics  # noqa: E402
from mw_inv.solver_triangulation import triangulate_cases  # noqa: E402
