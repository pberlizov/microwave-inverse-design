...
def finalize_promotion(manifest: RunManifest) -> PromotionAssessment:
    ...
    assessment = assess_promotion(
        ...
        campaign_block=manifest.evaluation.get("campaign"),
        deposit_envelope_gate=manifest.evaluation.get("deposit_envelope_gate"),
        deposit_calibration=manifest.evaluation.get("deposit_calibration"),
